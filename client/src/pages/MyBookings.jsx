            ...
            >
              <div className="flex flex-col md:flex-row gap-2">
                <img
                  ...
                  className="w-52 rounded shadow object-cover"
                />
              ...
              <div className="flex flex-col items-start justify-center pt-3">
                ...
                {!booking.isPaid && (
                  <button className="px-4 py-1.5 mt-4 text-sm border border-gray-400 rounded-full hover:bg-green-400 hover:text-white transition-all cursor-pointer duration-300">Pay Now</button>
                )}
              </div>
            </div>
          ))}
