  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Manage your hotel rooms, view booking statistics, and keep track of your guests and reservations all in one place."
      />

      <div className="flex gap-4 my-8">
        {/*Total Booking*/}
        <div className="bg-primary/10 border border-primary/10 rounded flex p-4 pr-8">
          <img
